...
public partial class BtchDet
{
    ...
    public virtual ICollection<Achqueue> Achqueues { get; set; } = new List<Achqueue>();

    public virtual ICollection<BatchSignatory> BatchSignatories { get; set; } = new List<BatchSignatory>();

    public virtual ICollection<ChecksD1> ChecksD1s { get; set; } = new List<ChecksD1>();

    public virtual ICollection<ChecksH3> ChecksH3s { get; set; } = new List<ChecksH3>();
}
